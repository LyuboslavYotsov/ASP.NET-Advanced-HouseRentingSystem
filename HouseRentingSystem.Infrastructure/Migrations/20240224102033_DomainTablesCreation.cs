...
{
    public partial class DomainTablesCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "Monthly rent price"),
                    ...
                    RenterId = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "House renter user identifier")
                },
                constraints: table =>
                {
